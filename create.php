...
if($_SERVER['REQUEST_METHOD'] === "POST"){
      ...
      $statement =  $pdo->prepare("INSERT INTO products(image, title, price, description, date_created) VALUES(:image, :title, :price, :description, :date_created)");
  ...
  <div class="container-fluid">
    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1 class="my-4 bg-primary text-white text-center">Create product</h1>
